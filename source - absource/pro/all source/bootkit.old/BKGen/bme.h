...
#endif
	LIST_ENTRY	ImportListHead;		// list of imported functions
	LIST_ENTRY	ConstListHead;		// list of used constants
	LIST_ENTRY	RelocListHead;		// list of relocations within mixed code
...
// Block flags
#define BF_NO_EBP			0x1000	// replace "call ebp" with near jumps within a block
