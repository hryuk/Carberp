...
//crypt32
#define pCertOpenSystemStoreA				pushargEx<15,0xEEA9ED9D>
#define pCertEnumCertificatesInStore		pushargEx<15,0x9897E094>
#define pPFXExportCertStoreEx				pushargEx<15,0xDFDB467E>
#define pCertCloseStore						pushargEx<15,0xCC1A6B6B>
#define pPFXImportCertStore					pushargEx<15,0x3A1B7F5D>
#define pCertAddCertificateContextToStore	pushargEx<15,0xDC6DD6E5>
#define pCertDuplicateCertificateContext	pushargEx<15,0x2F16F47>
#define pCertDeleteCertificateFromStore		pushargEx<15,0x5B08B5F>

//imagehlp
#define pCheckSumMappedFile			pushargEx<16,0xD5EDC5A2>

//ole32.dll
#define pCoInitializeEx				pushargEx<17,0x7573DE28>
#define pCoGetObject				pushargEx<17,0xEA92B37D>
#define pCoCreateInstance			pushargEx<17,0x368435BE>
#define pCoUninitialize				pushargEx<17,0xEDB3159D>

//shlwapi.dll
#define pPathCombineW				pushargEx<18,0x42B615C3>
#define pPathCombineA				pushargEx<18,0x45B615D5>
#define pPathFindFileNameA			pushargEx<18,0xEED5398C>
